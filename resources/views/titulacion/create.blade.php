...
@section('content')
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ url('titulacion') }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="titulo_actividad" id="titulo_actividad" value="{{old('titulo_actividad')}}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="number" class="form-control" name="cant_estudiantes" id="cant_estudiantes" value="{{old('cant_estudiantes')}}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="nombre_estudiante" id="nombre_estudiante" value="{{old('nombre_estudiante')}}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="number" class="form-control" name="cant_prof_guia" id="cant_prof_guia" value="{{old('cant_prof_guia')}}" required>
            </div>
        </div>
