...
<div class="flex-center position-ref full-height">
    ...
    <div class="content">
        ...
        <div class="links">
            ...
            <a href={{ url('extension') }}>Administrar Actividades de Extensión</a><br/><br/>
            ...
            <a href={{ url('indicadores') }}>Administrar Indicadores</a><br/><br/>
            <a href={{ url('consultas') }}>Consultar Actividades</a><br/><br/>
        </div>
    </div>
</div>
</body>
